...
Instr set_dp_i(Instr i, bool b) { return (i & ~0x2000000) | ((Instr)b << 25); }
Instr dp_s_mask(Instr i) { return (i & 0x100000) >> 20; }
Instr set_dp_s(Instr i, bool b) { return (i & ~0x100000) | ((Instr)b << 20); }
...
Instr set_dp_bit_31(Instr i, bool b) {
  return (i & ~0x80000000) | ((Instr)b << 31);
}
Instr sdt_mode_mask(Instr i) { return (i & 0x3000000) >> 24; }
Instr sdt_i_mask(Instr i) { return (i & 0x2000000) >> 25; }
Instr set_sdt_i(Instr i, bool b) { return (i & ~0x2000000) | ((Instr)b << 25); }
Instr sdt_p_mask(Instr i) { return (i & 0x1000000) >> 24; }
Instr set_sdt_p(Instr i, bool b) { return (i & ~0x1000000) | ((Instr)b << 24); }
Instr sdt_u_mask(Instr i) { return (i & 0x800000) >> 23; }
Instr set_sdt_u(Instr i, bool b) { return (i & ~0x800000) | ((Instr)b << 23); }
Instr sdt_l_mask(Instr i) { return (i & 0x100000) >> 20; }
Instr set_sdt_l(Instr i, bool b) { return (i & ~0x100000) | ((Instr)b << 20); }
...
Instr set_mul_a(Instr i, bool b) { return (i & ~0x200000) | ((Instr)b << 21); }
Instr mul_s_mask(Instr i) { return (i & 0x100000) >> 20; }
Instr set_mul_s(Instr i, bool b) { return (i & ~0x100000) | ((Instr)b << 20); }
...
Instr set_cpsr_n(Instr i, bool b) {
  return (i & ~0x80000000) | ((Instr)b << 31);
}
Instr cpsr_z_mask(Instr i) { return (i & 0x40000000) >> 30; }
Instr set_cpsr_z(Instr i, bool b) {
  return (i & ~0x40000000) | ((Instr)b << 30);
}
Instr cpsr_c_mask(Instr i) { return (i & 0x20000000) >> 29; }
Instr set_cpsr_c(Instr i, bool b) {
  return (i & ~0x20000000) | ((Instr)b << 29);
}
Instr cpsr_v_mask(Instr i) { return (i & 0x10000000) >> 28; }
Instr set_cpsr_v(Instr i, bool b) {
  return (i & ~0x10000000) | ((Instr)b << 28);
}
